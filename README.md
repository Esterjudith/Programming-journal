...
-(backlog, written on 9/25) The website has been completed but still waiting for the client to give final approval since he's been out of the country for some time. 
 ...
 # 10/15/2023
  ...
  #11/24/2023
  -I took a break from the health insurance project to work on my client's website.  After receiving the final payment I started transferring the website from local WordPress to the hosting company I advised the client to use.  I saved the project in a compressed zip file and then uploaded it to WordPress online, made sure all the API keys were transferred and tested the website on desktop and mobile. Noticed that the booking email notification was not working, did some research on SMTP, and contacted the hosting company.  I created an email account for the client and utilized their email as the admin for the booking plug-in, per the hosting company there were additional steps they had to take on their end.  They asked me to test it again in 24hrs. 
